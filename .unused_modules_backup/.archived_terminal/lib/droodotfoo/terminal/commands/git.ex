defmodule Droodotfoo.Terminal.Commands.Git do
  ...
  @impl true
  def execute("git", args, state), do: git(args, state)
  def execute("npm", args, state), do: npm(args, state)
  def execute("pip", args, state), do: pip(args, state)
  def execute("yarn", args, state), do: yarn(args, state)
  def execute("cargo", args, state), do: cargo(args, state)
  def execute("curl", args, state), do: curl(args, state)
  def execute("wget", args, state), do: wget(args, state)
  def execute("ping", args, state), do: ping(args, state)
  def execute("ssh", args, state), do: ssh(args, state)
  def execute("tar", args, state), do: tar(args, state)

  def execute(command, _args, state) do
    {:error, "Unknown development command: #{command}", state}
  end
