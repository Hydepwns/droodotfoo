defmodule Droodotfoo.Terminal.CommandParser do
  ...
  defp command_map do
    %{
      ...
      "crt" => &Commands.crt/2,
      # Games
      "tetris" => &Commands.tetris/2,
      "snake" => &Commands.snake/2,
      "wordle" => &Commands.wordle/2,
      "word" => &Commands.wordle/2,
      "2048" => &Commands.twenty48/2,
      "game48" => &Commands.twenty48/2,
      "conway" => &Commands.conway/2,
      "life" => &Commands.conway/2,
      "typing" => &Commands.typing/2,
      "type" => &Commands.typing/2,
      "wpm" => &Commands.typing/2,
      "calc" => &Commands.calc/2,
      "calculator" => &Commands.calc/2,
      # Music/Entertainment
