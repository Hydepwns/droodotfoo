...
👋 Hi I'm Drew.
Co-founder at [axol.io](https://axol.io) & [xochi.fi](https://xochi.fi).

> Building private execution infra on ETH: HFT solvers, sequencers, validators, ZK.
> Prev: Lido.fi && Blockdaemon Protocol Specialist
...
- [**xochi-erc-eip**](https://github.com/xochi-fi/erc-xochi-zkp) - Reference for Xochi ZKP Compliance Oracle

### Personal Site Stack

Elixir 1.17, Phoenix 1.8, LiveView, Tailwind v4, Monaspace fonts, PostgreSQL + pgvector.
Rust NIFs for Web3 crypto and markdown parsing. ETS caching.
...
Deployed on fly.io See [docs/guides/deployment.md](docs/guides/deployment.md).
