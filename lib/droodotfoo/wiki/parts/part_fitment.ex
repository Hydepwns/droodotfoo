defmodule Droodotfoo.Wiki.Parts.PartFitment do
  @moduledoc """
  ...
  schema "part_fitments" do
    belongs_to(:part, Droodotfoo.Wiki.Parts.Part, primary_key: true)
    belongs_to(:vehicle, Droodotfoo.Wiki.Parts.Vehicle, primary_key: true)
