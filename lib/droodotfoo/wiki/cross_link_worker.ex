defmodule Droodotfoo.Wiki.CrossLinkWorker do
  @moduledoc """
  ...
  ## Manual Invocation
      ...
      %{source: "osrs"} |> Droodotfoo.Wiki.CrossLinkWorker.new() |> Oban.insert()

      # Detect links for a specific article
      %{article_id: 123} |> Droodotfoo.Wiki.CrossLinkWorker.new() |> Oban.insert()
