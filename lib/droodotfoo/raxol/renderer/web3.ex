defmodule Droodotfoo.Raxol.Renderer.Web3 do
  ...
  def draw_connected(state) do
    ...
    wallet_details = [
      BoxBuilder.info_line("Wallet Address", abbreviated_address, label_width: 20)
    ]
        ...
        case Droodotfoo.Web3.resolve_ens(address) do
          {:ok, ens_name} when ens_name != address ->
            wallet_details ++
              [
                "",
                BoxBuilder.info_line("ENS Name", ens_name, label_width: 20)
              ]
    ...
    wallet_details =
      wallet_details ++
        [
          "",
          BoxBuilder.info_line("Network", network_name, label_width: 20)
        ]
