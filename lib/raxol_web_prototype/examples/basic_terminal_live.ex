defmodule RaxolWeb.Examples.BasicTerminalLive do
  ...
  defp create_initial_buffer do
    lines = [
      create_line("┌────────────────────────────────────────────────────────┐"),
      create_line("│                                                        │"),
      create_line("│           Welcome to RaxolWeb Terminal!               │", bold: true),
      create_line("│                                                        │"),
      ...
      create_line("│                                                        │"),
      create_line("│  Time: #{format_time(DateTime.utc_now())}                                │"),
  ...
  defp create_updated_buffer(key, count, time) do
    lines = [
      ...
      create_styled_line("│    • Box-drawing characters", :magenta),
      create_line("│                                                        │"),
      create_styled_line("│  Last key: #{String.pad_trailing(key, 40)} │", :bright_green),
      create_line("│                                                        │"),
      create_line("│  Time: #{format_time(time)}                                │"),
      create_line("│  Keys pressed: #{String.pad_trailing(to_string(count), 36)} │"),
      create_line("│                                                        │"),
      create_line("└────────────────────────────────────────────────────────┘")
    ]
