defmodule Wiki.Ingestion.VintageMachinerySyncWorker do
  @moduledoc """
  ...
  ## Manual Invocation
      ...
      Wiki.Ingestion.VintageMachinerySyncWorker.new(%{})
      |> Oban.insert()

      # Full sync
      Wiki.Ingestion.VintageMachinerySyncWorker.new(%{"strategy" => "full"})
      |> Oban.insert()

      # Limit pages processed
      Wiki.Ingestion.VintageMachinerySyncWorker.new(%{"limit" => 100})
      |> Oban.insert()
  ...
  alias Wiki.Ingestion.{SyncRun, VintageMachineryPipeline}
