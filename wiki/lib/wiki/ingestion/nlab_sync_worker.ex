defmodule Wiki.Ingestion.NLabSyncWorker do
  @moduledoc """
  ...
  ## Manual Invocation
      ...
      %{since: "2025-01-01T00:00:00Z"} |> Wiki.Ingestion.NLabSyncWorker.new() |> Oban.insert()
  ...
  alias Wiki.Ingestion.{NLabPipeline, SyncRun}
