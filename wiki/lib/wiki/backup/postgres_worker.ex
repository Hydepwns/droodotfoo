defmodule Wiki.Backup.PostgresWorker do
  @moduledoc """
  ...
  ## Manual Invocation
      ...
      # Run backup now
      %{} |> Wiki.Backup.PostgresWorker.new() |> Oban.insert()

      # Skip pruning
      %{prune: false} |> Wiki.Backup.PostgresWorker.new() |> Oban.insert()
  ...
  defp run_pg_dump(output_path) do
    db_config = Application.fetch_env!(:wiki, Wiki.Repo)
