    ...
    <Layouts.app flash={@flash}>
      <div class="max-w-4xl mx-auto px-4 py-8">
        <header class="flex items-start justify-between mb-6">
          <div>
            <.link navigate={~p"/parts"} class="text-sm text-zinc-500 hover:text-zinc-300 font-mono">
          ...
          <div class="flex gap-2">
            <.link
              navigate={~p"/parts/add?clipper=1&part_number=#{@part.part_number}"}
