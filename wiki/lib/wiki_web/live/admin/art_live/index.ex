defmodule WikiWeb.Admin.ArtLive.Index do
  @moduledoc """
    ...
    <Layouts.app flash={@flash}>
      <div class="max-w-6xl mx-auto px-4 py-8">
        <header class="flex items-center justify-between mb-8">
          ...
          <.link navigate={~p"/admin/art/add"} class="btn-primary">
            + Add Artwork
          </.link>
        </header>
    ...
    <div class="border border-zinc-800 rounded-lg overflow-hidden">
      ...
      <div class="p-4">
        ...
        <div class="mt-4 flex gap-2">
          <.link navigate={~p"/art/#{@artwork.slug}"} class="text-sm text-blue-400 hover:underline">
            View
          </.link>
          <.link
            navigate={~p"/admin/art/#{@artwork.slug}/edit"}
